...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-100 shadow-[0_-4px_24px_rgba(0,0,0,0.04)]">
      <nav className="fixed bottom-0 left-0 right-0 h-[4.8rem] bg-white border-t border-gray-100 shadow-[0_-4px_16px_rgba(0,0,0,0.06)] flex items-center justify-around z-50">
